...
describe('asyncMap', function() {
  ...
  xit('should pass the completed tasks to its callback', function(done){
  ...
  xit('should pass the completed tasks to its callback in the correct order', function(done) {
  ...
  xit('should handle more than two async functions in the correct order', function(done) {
    function wait2For2(callback){
      Test.setTimeout(function() {
        callback(2);
      }, 200, done.fail);
